...
import com.myrungo.rungo.Data;
import com.myrungo.rungo.MyService;
...
public final class StartActivity
    ...
    private void resetData() {
        getChronometer().stop();
        getDistance().setText("");
        getChronometer().setText(getString(R.string.zero_time));
        setData();
    }
...
//        });
    ...
    private void dressUp() {
        @NonNull final SharedPreferences prefs = getSharedPreferences("APP_DATA", Context.MODE_PRIVATE);

        //noinspection ConstantConditions
        @NonNull final String preferedSkin = prefs.getString("SKIN", CatView.Skins.COMMON.toString().toLowerCase());
